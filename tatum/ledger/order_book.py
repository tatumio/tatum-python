...
def list_all_historical_trades(API_KEY, query_params):
...
def list_all_active_buy_trades(API_KEY, query_params):
...
def list_all_active_sell_trades(API_KEY, query_params):
    validator.list_all_active_buy_trades(query_params)
    headers = { 'x-api-key': API_KEY }
...
def get_existing_trade(API_KEY, path_params):
...
def cancel_existing_trade(API_KEY, path_params):
    validator.id_path_param(path_params)
    headers = { 'x-api-key': API_KEY }
...
def cancel_all_existing_trades_for_account(API_KEY, path_params):
    validator.id_path_param(path_params)
    headers = { 'x-api-key': API_KEY }
...
def store_buy_sell_trade(API_KEY, body_params):

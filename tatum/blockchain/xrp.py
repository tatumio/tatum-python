...
def get_ledger(path_params):
    blockchain_validator.get_ledger(path_params)
    headers = { 'x-api-key': API_KEY }
...
def send_xrp_to_blockchain_addresses(body_params):
    blockchain_validator.send_xrp_to_blockchain_addresses(body_params)
...
def create_update_delete_xrp_trust_line(body_params):
    blockchain_validator.create_update_delete_xrp_trust_line(body_params)
    body_params = json.dumps(body_params)
    headers = {
        'content-type': "application/json",
        'x-api-key': API_KEY
...
def modify_xrp_account(body_params):
    blockchain_validator.modify_xrp_account(body_params)
    body_params = json.dumps(body_params)
    headers = {
        'content-type': "application/json",
        'x-api-key': API_KEY

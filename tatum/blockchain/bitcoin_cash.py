...
def get_bitcoin_cash_block_by_hash(path_params):
    blockchain_validator.bitcoin_cash_get_block_hash(path_params)
    headers = { 'x-api-key': API_KEY }
...
def get_bitcoin_cash_transaction_by_address(path_params, query_params = {}):
    blockchain_validator.get_bitcoin_cash_transaction_by_address(path_params, query_params)
    headers = { 'x-api-key': API_KEY }
    skip = ''
...
def send_bitcoin_cash_to_blockchain_addresses(body_params):
    blockchain_validator.send_bitcoin_cash_to_blockchain_addresses(body_params)
    body_params = json.dumps(body_params)
    headers = {
        'content-type': "application/json",
        'x-api-key': API_KEY

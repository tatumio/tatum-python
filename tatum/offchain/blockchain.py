...
def send_bitcoin_from_tatum_account_to_address(body_params):
    offchain_validator.send_from_tatum_account_to_address(body_params)
...
def send_ethereum_from_tatum_ledger_to_blockchain(body_params):
    offchain_validator.send_ethereum_from_tatum_ledger_to_blockchain(body_params)
    body_params = json.dumps(body_params)
    headers = {
        'content-type': "application/json",
        'x-api-key': API_KEY
...
def create_new_ERC20_token(body_params):
    offchain_validator.create_new_ERC20_token(body_params)
    body_params = json.dumps(body_params)
    headers = {
        'content-type': "application/json",
        'x-api-key': API_KEY
...
def deploy_ethereum_erc20_smart_contract_offchain(body_params):
    offchain_validator.deploy_ethereum_erc20_smart_contract_offchain(body_params)
    body_params = json.dumps(body_params)
    headers = {
        'content-type': "application/json",
        'x-api-key': API_KEY
...
def set_erc20_token_contract_address(path_params):
    offchain_validator.set_erc20_token_contract_address(path_params)
...
def transfer_ethereum_erc20_from_tatum_ledger_to_blockchain(body_params):
    offchain_validator.transfer_ethereum_erc20_from_tatum_ledger_to_blockchain(body_params)
    body_params = json.dumps(body_params)
    headers = {
        'content-type': "application/json",
        'x-api-key': API_KEY
...
def send_xlm_asset_from_tatum_ledger_to_blockchain(body_params):
    offchain_validator.send_xlm_asset_from_tatum_ledger_to_blockchain(body_params)
    body_params = json.dumps(body_params)
    headers = {
        'content-type': "application/json",
        'x-api-key': API_KEY
...
def create_xlm_based_asset(body_params):
    offchain_validator.create_xlm_based_asset(body_params)
    body_params = json.dumps(body_params)
    headers = {
        'content-type': "application/json",
        'x-api-key': API_KEY
...
def send_xrp_from_tatum_ledger_to_blockchain(body_params):
    offchain_validator.send_xrp_from_tatum_ledger_to_blockchain(body_params)
    body_params = json.dumps(body_params)
    headers = {
        'content-type': "application/json",
        'x-api-key': API_KEY
...
def create_xrp_based_asset(body_params):
    offchain_validator.create_xrp_based_asset(body_params)
    body_params = json.dumps(body_params)
    headers = {
        'content-type': "application/json",
        'x-api-key': API_KEY

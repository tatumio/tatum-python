...
def create_new_deposit_address(path_params, query_params = {}):
    offchain_validator.create_new_deposit_address(path_params, query_params)
...
def get_all_deposit_addresses_for_account(path_params):
    offchain_validator.id_path_param(path_params)
    headers = { 'x-api-key': API_KEY }
...
def check_if_deposit_address_is_asigned(path_params, query_params = {}):
    offchain_validator.check_if_deposit_address_is_asigned(path_params, query_params)
    headers = { 'x-api-key': API_KEY }
    index = ''
    if query_params != {}:
        index = 'index={}'.format(query_params['index'])
...
def remove_address_for_account(path_params):
    offchain_validator.remove_address_for_account(path_params)
    headers = { 'x-api-key': API_KEY }
